...
const Card = ({btnText="Buy Now"}) => {
  return (
    <div>
      <div class="bg-white p-3 rounded-xl flex font-sans mb-4">
        <div class="flex-none w-48 relative">
          <img
            src="https://images.pexels.com/photos/19071766/pexels-photo-19071766/free-photo-of-woman-standing-by-wall-in-subway-in-black-and-white.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1"
            alt=""
